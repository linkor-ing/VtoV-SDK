...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_argw_C;                        // 0x0378(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AProp_argw_C) == 0x000398, "Wrong size on AProp_argw_C");
static_assert(offsetof(AProp_argw_C, UberGraphFrame_Prop_argw_C) == 0x000378, "Member 'AProp_argw_C::UberGraphFrame_Prop_argw_C' has a wrong offset!");
static_assert(offsetof(AProp_argw_C, PointLight) == 0x000380, "Member 'AProp_argw_C::PointLight' has a wrong offset!");
static_assert(offsetof(AProp_argw_C, Dynmat_0) == 0x000388, "Member 'AProp_argw_C::Dynmat_0' has a wrong offset!");
static_assert(offsetof(AProp_argw_C, Dynmat_1) == 0x000390, "Member 'AProp_argw_C::Dynmat_1' has a wrong offset!");
