...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_food_potatoCooked_C;           // 0x03D0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AProp_food_potatoCooked_C) == 0x0003D8, "Wrong size on AProp_food_potatoCooked_C");
static_assert(offsetof(AProp_food_potatoCooked_C, UberGraphFrame_Prop_food_potatoCooked_C) == 0x0003D0, "Member 'AProp_food_potatoCooked_C::UberGraphFrame_Prop_food_potatoCooked_C' has a wrong offset!");
