...
static_assert(offsetof(Panel_radar_C_ExecuteUbergraph_panel_radar, K2Node_Event_action) == 0x0000D8, "Member 'Panel_radar_C_ExecuteUbergraph_panel_radar::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Panel_radar_C_ExecuteUbergraph_panel_radar, K2Node_SwitchEnum_CmpSuccess) == 0x0000D9, "Member 'Panel_radar_C_ExecuteUbergraph_panel_radar::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
