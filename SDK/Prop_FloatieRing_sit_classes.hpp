...
{
public:
	uint8                                         Pad_26FF[0x7];                                     // 0x0361(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AProp_FloatieRing_sit_C) == 0x000370, "Wrong size on AProp_FloatieRing_sit_C");
static_assert(offsetof(AProp_FloatieRing_sit_C, ChildActor) == 0x000368, "Member 'AProp_FloatieRing_sit_C::ChildActor' has a wrong offset!");
