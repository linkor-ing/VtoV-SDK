...
{
public:
	uint8                                         Pad_3A69[0x7];                                     // 0x0361(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AProp_sitCouchS_C) == 0x000370, "Wrong size on AProp_sitCouchS_C");
static_assert(offsetof(AProp_sitCouchS_C, ChildActor) == 0x000368, "Member 'AProp_sitCouchS_C::ChildActor' has a wrong offset!");
