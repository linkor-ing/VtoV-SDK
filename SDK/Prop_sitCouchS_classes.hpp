...
static_assert(sizeof(AProp_sitCouchS_C) == 0x000380, "Wrong size on AProp_sitCouchS_C");
static_assert(offsetof(AProp_sitCouchS_C, ChildActor) == 0x000378, "Member 'AProp_sitCouchS_C::ChildActor' has a wrong offset!");
