...
{
public:
	uint8                                         Pad_E1C[0x7];                                      // 0x0361(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AProp_sitChair3_C) == 0x000370, "Wrong size on AProp_sitChair3_C");
static_assert(offsetof(AProp_sitChair3_C, ChildActor) == 0x000368, "Member 'AProp_sitChair3_C::ChildActor' has a wrong offset!");
