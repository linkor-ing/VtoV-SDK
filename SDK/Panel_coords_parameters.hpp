...
public:
	...
	uint8                                         Pad_310A[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_310B[0x4];                                     // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_310C[0x7];                                     // 0x0069(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_310D[0x7];                                     // 0x0079(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	Enum_interactionActions                       K2Node_Event_action;                               // 0x0114(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Panel_coords_C_ExecuteUbergraph_panel_coords, K2Node_Event_index) == 0x000110, "Member 'Panel_coords_C_ExecuteUbergraph_panel_coords::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(Panel_coords_C_ExecuteUbergraph_panel_coords, K2Node_Event_action) == 0x000114, "Member 'Panel_coords_C_ExecuteUbergraph_panel_coords::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Panel_coords_C_ExecuteUbergraph_panel_coords, K2Node_SwitchEnum_CmpSuccess) == 0x000115, "Member 'Panel_coords_C_ExecuteUbergraph_panel_coords::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
...
static_assert(offsetof(Panel_coords_C_ActionOptionIndex, Param_Index) == 0x000090, "Member 'Panel_coords_C_ActionOptionIndex::Param_Index' has a wrong offset!");
static_assert(offsetof(Panel_coords_C_ActionOptionIndex, Action) == 0x000094, "Member 'Panel_coords_C_ActionOptionIndex::Action' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_310E[0x7];                                     // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 Text;                                              // 0x0098(0x0010)(Parm, OutParm, ZeroConstructor, HasGetValueTypeHash)
	class UPrimitiveComponent*                    boundObjectReplace;                                // 0x00A8(0x0008)(Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                   CallFunc_MakeLiteralText_ReturnValue;              // 0x00B0(0x0018)()
	bool                                          CallFunc_lookAt_return;                            // 0x00C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_310F[0x7];                                     // 0x00C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CallFunc_lookAt_text;                              // 0x00D0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class UPrimitiveComponent*                    CallFunc_lookAt_boundObjectReplace;                // 0x00E0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Panel_coords_C_LookAt) == 0x0000F8, "Wrong size on Panel_coords_C_LookAt");
...
static_assert(offsetof(Panel_coords_C_LookAt, CallFunc_MakeLiteralText_ReturnValue) == 0x0000B0, "Member 'Panel_coords_C_LookAt::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Panel_coords_C_LookAt, CallFunc_lookAt_return) == 0x0000C8, "Member 'Panel_coords_C_LookAt::CallFunc_lookAt_return' has a wrong offset!");
static_assert(offsetof(Panel_coords_C_LookAt, CallFunc_lookAt_text) == 0x0000D0, "Member 'Panel_coords_C_LookAt::CallFunc_lookAt_text' has a wrong offset!");
static_assert(offsetof(Panel_coords_C_LookAt, CallFunc_lookAt_boundObjectReplace) == 0x0000E0, "Member 'Panel_coords_C_LookAt::CallFunc_lookAt_boundObjectReplace' has a wrong offset!");
static_assert(offsetof(Panel_coords_C_LookAt, CallFunc_Conv_TextToString_ReturnValue) == 0x0000E8, "Member 'Panel_coords_C_LookAt::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(Panel_coords_C_GetActionOptions) == 0x000058, "Wrong size on Panel_coords_C_GetActionOptions");
...
static_assert(offsetof(Panel_coords_C_GetActionOptions, K2Node_MakeArray_Array) == 0x000048, "Member 'Panel_coords_C_GetActionOptions::K2Node_MakeArray_Array' has a wrong offset!");
