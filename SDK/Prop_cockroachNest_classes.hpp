...
{
public:
	uint8                                         Pad_39B1[0x7];                                     // 0x0361(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_cockroachNest_C;               // 0x0368(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AProp_cockroachNest_C) == 0x000370, "Wrong size on AProp_cockroachNest_C");
static_assert(offsetof(AProp_cockroachNest_C, UberGraphFrame_Prop_cockroachNest_C) == 0x000368, "Member 'AProp_cockroachNest_C::UberGraphFrame_Prop_cockroachNest_C' has a wrong offset!");
