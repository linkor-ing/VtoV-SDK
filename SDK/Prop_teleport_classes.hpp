...
{
public:
	uint8                                         Pad_1F8E[0x7];                                     // 0x0361(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AProp_teleport_C) == 0x000370, "Wrong size on AProp_teleport_C");
static_assert(offsetof(AProp_teleport_C, ChildActor) == 0x000368, "Member 'AProp_teleport_C::ChildActor' has a wrong offset!");
