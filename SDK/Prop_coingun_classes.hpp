...
{
public:
	uint8                                         Pad_2B4C[0x7];                                     // 0x0361(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_coingun_C;                     // 0x0368(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AProp_coingun_C) == 0x000370, "Wrong size on AProp_coingun_C");
static_assert(offsetof(AProp_coingun_C, UberGraphFrame_Prop_coingun_C) == 0x000368, "Member 'AProp_coingun_C::UberGraphFrame_Prop_coingun_C' has a wrong offset!");
