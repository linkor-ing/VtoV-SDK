...
{
public:
	uint8                                         Pad_37ED[0x7];                                     // 0x0361(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_screwdriver_C;                 // 0x0368(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AProp_screwdriver_C) == 0x000378, "Wrong size on AProp_screwdriver_C");
static_assert(offsetof(AProp_screwdriver_C, UberGraphFrame_Prop_screwdriver_C) == 0x000368, "Member 'AProp_screwdriver_C::UberGraphFrame_Prop_screwdriver_C' has a wrong offset!");
static_assert(offsetof(AProp_screwdriver_C, VelocityStuck) == 0x000370, "Member 'AProp_screwdriver_C::VelocityStuck' has a wrong offset!");
