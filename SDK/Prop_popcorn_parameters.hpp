...
public:
	...
	uint8                                         Pad_3AA7[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3AA8[0x3];                                     // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3AA9[0x8];                                     // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          CallFunc_addFood_full;                             // 0x0116(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_3AAA[0x1];                                     // 0x0117(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3AAB[0x2];                                     // 0x0126(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(Prop_popcorn_C_ExecuteUbergraph_prop_popcorn, K2Node_Event_index) == 0x000110, "Member 'Prop_popcorn_C_ExecuteUbergraph_prop_popcorn::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(Prop_popcorn_C_ExecuteUbergraph_prop_popcorn, K2Node_Event_action) == 0x000114, "Member 'Prop_popcorn_C_ExecuteUbergraph_prop_popcorn::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Prop_popcorn_C_ExecuteUbergraph_prop_popcorn, K2Node_SwitchEnum_CmpSuccess) == 0x000115, "Member 'Prop_popcorn_C_ExecuteUbergraph_prop_popcorn::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Prop_popcorn_C_ExecuteUbergraph_prop_popcorn, CallFunc_addFood_full) == 0x000116, "Member 'Prop_popcorn_C_ExecuteUbergraph_prop_popcorn::CallFunc_addFood_full' has a wrong offset!");
...
static_assert(offsetof(Prop_popcorn_C_ActionOptionIndex, Param_Index) == 0x000090, "Member 'Prop_popcorn_C_ActionOptionIndex::Param_Index' has a wrong offset!");
static_assert(offsetof(Prop_popcorn_C_ActionOptionIndex, Action) == 0x000094, "Member 'Prop_popcorn_C_ActionOptionIndex::Action' has a wrong offset!");
...
static_assert(sizeof(Prop_popcorn_C_GetActionOptions) == 0x000058, "Wrong size on Prop_popcorn_C_GetActionOptions");
...
static_assert(offsetof(Prop_popcorn_C_GetActionOptions, K2Node_MakeArray_Array) == 0x000048, "Member 'Prop_popcorn_C_GetActionOptions::K2Node_MakeArray_Array' has a wrong offset!");
