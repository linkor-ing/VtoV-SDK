...
static_assert(sizeof(Prop_food_potato_q_C_Cooked) == 0x0001A0, "Wrong size on Prop_food_potato_q_C_Cooked");
...
static_assert(offsetof(Prop_food_potato_q_C_Cooked, CallFunc_Conv_NameToString_ReturnValue) == 0x000178, "Member 'Prop_food_potato_q_C_Cooked::CallFunc_Conv_NameToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_food_potato_q_C_Cooked, K2Node_DynamicCast_AsProp_Food) == 0x000188, "Member 'Prop_food_potato_q_C_Cooked::K2Node_DynamicCast_AsProp_Food' has a wrong offset!");
static_assert(offsetof(Prop_food_potato_q_C_Cooked, K2Node_DynamicCast_bSuccess_1) == 0x000190, "Member 'Prop_food_potato_q_C_Cooked::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
