...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_bed_C;                              // 0x0378(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	bool                                          DropItem;                                          // 0x0380(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(Abed_C) == 0x000388, "Wrong size on Abed_C");
static_assert(offsetof(Abed_C, UberGraphFrame_bed_C) == 0x000378, "Member 'Abed_C::UberGraphFrame_bed_C' has a wrong offset!");
static_assert(offsetof(Abed_C, DropItem) == 0x000380, "Member 'Abed_C::DropItem' has a wrong offset!");
