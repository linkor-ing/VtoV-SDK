...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_bombbox_C;                     // 0x0378(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UBillboardComponent*                    Exp;                                               // 0x0380(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AProp_bombbox_C) == 0x000388, "Wrong size on AProp_bombbox_C");
static_assert(offsetof(AProp_bombbox_C, UberGraphFrame_Prop_bombbox_C) == 0x000378, "Member 'AProp_bombbox_C::UberGraphFrame_Prop_bombbox_C' has a wrong offset!");
static_assert(offsetof(AProp_bombbox_C, Exp) == 0x000380, "Member 'AProp_bombbox_C::Exp' has a wrong offset!");
