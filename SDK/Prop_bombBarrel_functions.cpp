...
void AProp_bombBarrel_C::AddDamage(class AActor* Actor, float Damage, const struct FHitResult& Param_Hit, const struct FVector& Param_Impact, bool SkipSetting)
{
	static class UFunction* Func = nullptr;
