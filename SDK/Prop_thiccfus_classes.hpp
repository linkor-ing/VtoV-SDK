...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_thiccfus_C;                    // 0x0378(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AProp_thiccfus_C) == 0x000388, "Wrong size on AProp_thiccfus_C");
static_assert(offsetof(AProp_thiccfus_C, UberGraphFrame_Prop_thiccfus_C) == 0x000378, "Member 'AProp_thiccfus_C::UberGraphFrame_Prop_thiccfus_C' has a wrong offset!");
static_assert(offsetof(AProp_thiccfus_C, Mushrooms) == 0x000380, "Member 'AProp_thiccfus_C::Mushrooms' has a wrong offset!");
