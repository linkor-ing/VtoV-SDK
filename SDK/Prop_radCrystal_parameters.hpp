...
static_assert(offsetof(Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal, K2Node_Event_damage) == 0x0000A8, "Member 'Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal::K2Node_Event_damage' has a wrong offset!");
static_assert(offsetof(Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal, CallFunc_BreakHitResult_bBlockingHit) == 0x0000AC, "Member 'Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal, CallFunc_BreakHitResult_bInitialOverlap) == 0x0000AD, "Member 'Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal, CallFunc_BreakHitResult_Time) == 0x0000B0, "Member 'Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal, CallFunc_BreakHitResult_Distance) == 0x0000B4, "Member 'Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal, CallFunc_BreakHitResult_Location) == 0x0000B8, "Member 'Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal, CallFunc_BreakHitResult_ImpactPoint) == 0x0000C4, "Member 'Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal, CallFunc_BreakHitResult_Normal) == 0x0000D0, "Member 'Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal, CallFunc_BreakHitResult_ImpactNormal) == 0x0000DC, "Member 'Prop_radCrystal_C_ExecuteUbergraph_prop_radCrystal::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
