...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04C39860;
	constexpr int32 AppendString      = 0x011ADEF0;
	constexpr int32 GNames            = 0x04BFD500;
	constexpr int32 GWorld            = 0x04D7D8C0;
	constexpr int32 ProcessEvent      = 0x0139EBE0;
