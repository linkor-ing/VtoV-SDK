...
static_assert(offsetof(Warpbox_C_TexturePickerApply, Param_Index) == 0x000010, "Member 'Warpbox_C_TexturePickerApply::Param_Index' has a wrong offset!");
...
static_assert(sizeof(Warpbox_C_SettingsApplied) == 0x0000F0, "Wrong size on Warpbox_C_SettingsApplied");
...
public:
	...
	struct FStruct_settings                       K2Node_Event_settings;                             // 0x0390(0x00F0)(HasGetValueTypeHash)
	...
	ECollisionEnabled                             K2Node_Select_Default_2;                           // 0x0489(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_48A[0x6];                                      // 0x048A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundBase*                             K2Node_Select_Default_3;                           // 0x0490(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AMainGamemode_C*                        CallFunc_getMainGamemode_AsMain_Gamemode;          // 0x0498(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AMainPlayer_C*                          K2Node_Event_player;                               // 0x04A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                             K2Node_Event_hit;                                  // 0x04A8(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	Enum_interactionActions                       K2Node_Event_action;                               // 0x0530(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ECollisionEnabled                             K2Node_Select_Default_4;                           // 0x0531(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(Warpbox_C_ExecuteUbergraph_warpbox) == 0x000008, "Wrong alignment on Warpbox_C_ExecuteUbergraph_warpbox");
static_assert(sizeof(Warpbox_C_ExecuteUbergraph_warpbox) == 0x000538, "Wrong size on Warpbox_C_ExecuteUbergraph_warpbox");
...
static_assert(offsetof(Warpbox_C_ExecuteUbergraph_warpbox, CallFunc_getMainGameInstance_AsGame_Inst) == 0x000480, "Member 'Warpbox_C_ExecuteUbergraph_warpbox::CallFunc_getMainGameInstance_AsGame_Inst' has a wrong offset!");
static_assert(offsetof(Warpbox_C_ExecuteUbergraph_warpbox, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000488, "Member 'Warpbox_C_ExecuteUbergraph_warpbox::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Warpbox_C_ExecuteUbergraph_warpbox, K2Node_Select_Default_2) == 0x000489, "Member 'Warpbox_C_ExecuteUbergraph_warpbox::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(Warpbox_C_ExecuteUbergraph_warpbox, K2Node_Select_Default_3) == 0x000490, "Member 'Warpbox_C_ExecuteUbergraph_warpbox::K2Node_Select_Default_3' has a wrong offset!");
static_assert(offsetof(Warpbox_C_ExecuteUbergraph_warpbox, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x000498, "Member 'Warpbox_C_ExecuteUbergraph_warpbox::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(Warpbox_C_ExecuteUbergraph_warpbox, K2Node_Event_player) == 0x0004A0, "Member 'Warpbox_C_ExecuteUbergraph_warpbox::K2Node_Event_player' has a wrong offset!");
static_assert(offsetof(Warpbox_C_ExecuteUbergraph_warpbox, K2Node_Event_hit) == 0x0004A8, "Member 'Warpbox_C_ExecuteUbergraph_warpbox::K2Node_Event_hit' has a wrong offset!");
static_assert(offsetof(Warpbox_C_ExecuteUbergraph_warpbox, K2Node_Event_action) == 0x000530, "Member 'Warpbox_C_ExecuteUbergraph_warpbox::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Warpbox_C_ExecuteUbergraph_warpbox, K2Node_Select_Default_4) == 0x000531, "Member 'Warpbox_C_ExecuteUbergraph_warpbox::K2Node_Select_Default_4' has a wrong offset!");
