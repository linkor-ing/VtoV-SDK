...
public:
	...
	class AMainGamemode_C*                        CallFunc_getMainGamemode_AsMain_Gamemode_1;        // 0x01A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class UTexture2D*>                     K2Node_Select_Default;                             // 0x01B0(0x0010)(ReferenceParm)
	class UUmg_texturePicker_C*                   K2Node_Event_picker;                               // 0x01C0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTexture2D*                             K2Node_Event_texture;                              // 0x01C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Prop_picture_h_C_ExecuteUbergraph_prop_picture_h, K2Node_SwitchEnum_CmpSuccess) == 0x000198, "Member 'Prop_picture_h_C_ExecuteUbergraph_prop_picture_h::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Prop_picture_h_C_ExecuteUbergraph_prop_picture_h, CallFunc_getMainGamemode_AsMain_Gamemode) == 0x0001A0, "Member 'Prop_picture_h_C_ExecuteUbergraph_prop_picture_h::CallFunc_getMainGamemode_AsMain_Gamemode' has a wrong offset!");
static_assert(offsetof(Prop_picture_h_C_ExecuteUbergraph_prop_picture_h, CallFunc_getMainGamemode_AsMain_Gamemode_1) == 0x0001A8, "Member 'Prop_picture_h_C_ExecuteUbergraph_prop_picture_h::CallFunc_getMainGamemode_AsMain_Gamemode_1' has a wrong offset!");
static_assert(offsetof(Prop_picture_h_C_ExecuteUbergraph_prop_picture_h, K2Node_Select_Default) == 0x0001B0, "Member 'Prop_picture_h_C_ExecuteUbergraph_prop_picture_h::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Prop_picture_h_C_ExecuteUbergraph_prop_picture_h, K2Node_Event_picker) == 0x0001C0, "Member 'Prop_picture_h_C_ExecuteUbergraph_prop_picture_h::K2Node_Event_picker' has a wrong offset!");
static_assert(offsetof(Prop_picture_h_C_ExecuteUbergraph_prop_picture_h, K2Node_Event_texture) == 0x0001C8, "Member 'Prop_picture_h_C_ExecuteUbergraph_prop_picture_h::K2Node_Event_texture' has a wrong offset!");
static_assert(offsetof(Prop_picture_h_C_ExecuteUbergraph_prop_picture_h, K2Node_Event_index) == 0x0001D0, "Member 'Prop_picture_h_C_ExecuteUbergraph_prop_picture_h::K2Node_Event_index' has a wrong offset!");
...
static_assert(sizeof(Prop_picture_h_C_SettingsApplied) == 0x0000F0, "Wrong size on Prop_picture_h_C_SettingsApplied");
...
static_assert(offsetof(Prop_picture_h_C_TexturePickerApply, Param_Index) == 0x000010, "Member 'Prop_picture_h_C_TexturePickerApply::Param_Index' has a wrong offset!");
