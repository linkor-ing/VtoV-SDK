...
static_assert(sizeof(AProp_sitChair5_C) == 0x000380, "Wrong size on AProp_sitChair5_C");
static_assert(offsetof(AProp_sitChair5_C, ChildActor) == 0x000378, "Member 'AProp_sitChair5_C::ChildActor' has a wrong offset!");
