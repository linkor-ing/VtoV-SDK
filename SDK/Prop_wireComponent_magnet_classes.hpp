...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_wireComponent_magnet_C;        // 0x0370(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	...
	TArray<class UPrimitiveComponent*>            Comps;                                             // 0x0380(0x0010)(Edit, BlueprintVisible, ContainsInstancedReference)
	float                                         Radius;                                            // 0x0390(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         PeakForce;                                         // 0x0394(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AProp_wireComponent_magnet_C) == 0x000398, "Wrong size on AProp_wireComponent_magnet_C");
static_assert(offsetof(AProp_wireComponent_magnet_C, UberGraphFrame_Prop_wireComponent_magnet_C) == 0x000370, "Member 'AProp_wireComponent_magnet_C::UberGraphFrame_Prop_wireComponent_magnet_C' has a wrong offset!");
static_assert(offsetof(AProp_wireComponent_magnet_C, Sphere) == 0x000378, "Member 'AProp_wireComponent_magnet_C::Sphere' has a wrong offset!");
static_assert(offsetof(AProp_wireComponent_magnet_C, Comps) == 0x000380, "Member 'AProp_wireComponent_magnet_C::Comps' has a wrong offset!");
static_assert(offsetof(AProp_wireComponent_magnet_C, Radius) == 0x000390, "Member 'AProp_wireComponent_magnet_C::Radius' has a wrong offset!");
static_assert(offsetof(AProp_wireComponent_magnet_C, PeakForce) == 0x000394, "Member 'AProp_wireComponent_magnet_C::PeakForce' has a wrong offset!");
