...
static_assert(sizeof(AProp_crystal_C) == 0x000388, "Wrong size on AProp_crystal_C");
static_assert(offsetof(AProp_crystal_C, RadarPoint) == 0x000378, "Member 'AProp_crystal_C::RadarPoint' has a wrong offset!");
static_assert(offsetof(AProp_crystal_C, PointLight) == 0x000380, "Member 'AProp_crystal_C::PointLight' has a wrong offset!");
