...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_wireComponent_laserReceiver_C; // 0x0370(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AProp_wireComponent_laserReceiver_C) == 0x000380, "Wrong size on AProp_wireComponent_laserReceiver_C");
static_assert(offsetof(AProp_wireComponent_laserReceiver_C, UberGraphFrame_Prop_wireComponent_laserReceiver_C) == 0x000370, "Member 'AProp_wireComponent_laserReceiver_C::UberGraphFrame_Prop_wireComponent_laserReceiver_C' has a wrong offset!");
static_assert(offsetof(AProp_wireComponent_laserReceiver_C, Wire) == 0x000378, "Member 'AProp_wireComponent_laserReceiver_C::Wire' has a wrong offset!");
