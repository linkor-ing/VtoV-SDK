...
public:
	...
	uint8                                         Pad_3A23[0x8];                                     // 0x0008(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3A24[0x3];                                     // 0x0065(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_Add_IntInt_ReturnValue;                   // 0x0068(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3A25[0x4];                                     // 0x006C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3A26[0x2];                                     // 0x0106(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CallFunc_RandomPointInBoundingBox_ReturnValue;     // 0x0108(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_3A27[0x8];                                     // 0x0128(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(Prop_ubaitBox_C_ExecuteUbergraph_prop_ubaitBox, K2Node_Event_index) == 0x000100, "Member 'Prop_ubaitBox_C_ExecuteUbergraph_prop_ubaitBox::K2Node_Event_index' has a wrong offset!");
static_assert(offsetof(Prop_ubaitBox_C_ExecuteUbergraph_prop_ubaitBox, K2Node_Event_action) == 0x000104, "Member 'Prop_ubaitBox_C_ExecuteUbergraph_prop_ubaitBox::K2Node_Event_action' has a wrong offset!");
static_assert(offsetof(Prop_ubaitBox_C_ExecuteUbergraph_prop_ubaitBox, K2Node_SwitchEnum_CmpSuccess) == 0x000105, "Member 'Prop_ubaitBox_C_ExecuteUbergraph_prop_ubaitBox::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Prop_ubaitBox_C_ExecuteUbergraph_prop_ubaitBox, CallFunc_RandomPointInBoundingBox_ReturnValue) == 0x000108, "Member 'Prop_ubaitBox_C_ExecuteUbergraph_prop_ubaitBox::CallFunc_RandomPointInBoundingBox_ReturnValue' has a wrong offset!");
static_assert(offsetof(Prop_ubaitBox_C_ExecuteUbergraph_prop_ubaitBox, CallFunc_TransformLocation_ReturnValue) == 0x000114, "Member 'Prop_ubaitBox_C_ExecuteUbergraph_prop_ubaitBox::CallFunc_TransformLocation_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Prop_ubaitBox_C_ActionOptionIndex, Param_Index) == 0x000090, "Member 'Prop_ubaitBox_C_ActionOptionIndex::Param_Index' has a wrong offset!");
static_assert(offsetof(Prop_ubaitBox_C_ActionOptionIndex, Action) == 0x000094, "Member 'Prop_ubaitBox_C_ActionOptionIndex::Action' has a wrong offset!");
...
static_assert(sizeof(Prop_ubaitBox_C_GetActionOptions) == 0x000058, "Wrong size on Prop_ubaitBox_C_GetActionOptions");
...
static_assert(offsetof(Prop_ubaitBox_C_GetActionOptions, K2Node_MakeArray_Array) == 0x000048, "Member 'Prop_ubaitBox_C_GetActionOptions::K2Node_MakeArray_Array' has a wrong offset!");
