...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Prop_map_C;                         // 0x0378(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	...
	class UUmg_minimap_C*                         Minimap;                                           // 0x0390(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AProp_map_C) == 0x000398, "Wrong size on AProp_map_C");
static_assert(offsetof(AProp_map_C, UberGraphFrame_Prop_map_C) == 0x000378, "Member 'AProp_map_C::UberGraphFrame_Prop_map_C' has a wrong offset!");
static_assert(offsetof(AProp_map_C, RectLight) == 0x000380, "Member 'AProp_map_C::RectLight' has a wrong offset!");
static_assert(offsetof(AProp_map_C, Widget) == 0x000388, "Member 'AProp_map_C::Widget' has a wrong offset!");
static_assert(offsetof(AProp_map_C, Minimap) == 0x000390, "Member 'AProp_map_C::Minimap' has a wrong offset!");
